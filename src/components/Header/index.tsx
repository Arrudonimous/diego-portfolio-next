    ...
    <div className='flex items-center justify-center flex-col' id='Header'>
      ...
      <nav className='bg-footer w-full items-center py-3 rounded-2xl justify-center hidden md:flex gap-24'>
        <ul className='flex flex-row gap-10 text-white opacity-50 text-lg'>
          <a
            href='#Home'
            className='text-text font-bold hover:cursor-pointer hover:opacity-80'
          >
            {t(T_PREFIX_NAVBAR + 'HOME')}
          </a>
          <a href='#About' className='hover:cursor-pointer hover:opacity-80'>
            {t(T_PREFIX_NAVBAR + 'ABOUT')}
          </a>
          <a
            href='#Portfolio'
            className='hover:cursor-pointer hover:opacity-80'
          >
            {t(T_PREFIX_NAVBAR + 'PORTFOLIO')}
          </a>
          <a href='#Skills' className='hover:cursor-pointer hover:opacity-80'>
            {t(T_PREFIX_NAVBAR + 'SKILLS')}
          </a>
          <a
            href='#Recomendations'
            className='hover:cursor-pointer hover:opacity-80'
          >
            {t(T_PREFIX_NAVBAR + 'RECOMENDATIONS')}
          </a>
          <a href='#Contacts' className='hover:cursor-pointer hover:opacity-80'>
            {t(T_PREFIX_NAVBAR + 'CONTACTS')}
          </a>
        </ul>
      ...
      <div className='md:flex md:flex-row md:w-full md:justify-between md:mt-16 w-full'>
        <div className='hover:scale-[1.01]'>
          <div className='flex items-center justify-center m-0'>
            <img
              ...
              alt=''
              className='w-[14rem] md:h-[18rem] flex md:hidden absolute'
            />
            <img
              src='/assets/images/Icons.png'
              alt=''
              className='absolute md:hidden animate-spin-slow opacity-50 w-[18rem]'
            />
            <img
              src='/assets/images/Avatar.svg'
              alt=''
              className='md:hidden w-[14rem] mt-24 z-50'
            />
          </div>
        </div>
        ...
        <div className='md:flex w-full mt-9 md:w-1/3 md:mt-0 md:flex-col md:justify-center'>
          ...
          <h1 className='text-white font-extrabold text-5xl md:text-[3.25rem] mt-4'>
            Diego
          </h1>
          <h1 className='text-white font-extrabold text-5xl mb-1'>Arruda</h1>
          <span className='text-white opacity-50 text-lg md:text-xl md:mt-4 md:mb-6'>
            FullStack Developer
          </span>
          ...
          <div className='flex justify-center'>
            <div className='hidden md:flex'>
              <img
                src='/assets/images/Background.svg'
                alt=''
                className='w-[24rem] md:h-[24rem] hidden md:flex absolute'
              />
              <img
                src='/assets/images/Icons.png'
                alt=''
                className='absolute hidden md:flex animate-spin-slow opacity-50'
              />
            </div>
            <img
              src='/assets/images/Avatar.svg'
              alt=''
              className='hidden md:flex w-[24rem] md:h-[24rem] z-50 mt-14 ml-1'
            />
          </div>
        </div>
        ...
        <div className='flex items-center justify-center md:hidden'>
          <a
            href='#About'
            className='flex bg-footer p-4 rounded-[6rem] border-2 border-border mt-8 text-text animate-bounce hover:cursor-pointer'
          >
            <FiArrowDown size={30} />
          </a>
        </div>
